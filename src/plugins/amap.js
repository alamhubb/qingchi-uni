...
AMapWX.prototype.getWxLocation = function (a, b) {
  wx.getLocation({
    type: 'gcj02',
    success: function (a) {
      const c = a.longitude + ',' + a.latitude
    ...
    wx.request({
      ...
      success: function (b) {
        ...
        b.data.status && b.data.status == '1' ? (d = b.data.regeocode, e = d.addressComponent, f = [], g = '', d && d.roads[0] && d.roads[0].name && (g = d.roads[0].name + '附近'), h = c.split(',')[0], i = c.split(',')[1], d.pois && d.pois[0] && (g = d.pois[0].name + '附近', j = d.pois[0].location, j && (h = parseFloat(j.split(',')[0]), i = parseFloat(j.split(',')[1]))), e.provice && f.push(e.provice), e.city && f.push(e.city), e.district && f.push(e.district), e.streetNumber && e.streetNumber.street && e.streetNumber.number ? (f.push(e.streetNumber.street), f.push(e.streetNumber.number)) : (k = '', d && d.roads[0] && d.roads[0].name && (k = d.roads[0].name), f.push(k)), f = f.join(''), l = [{
          ...
          id: 0,
          regeocodeData: d
        }], a.success(l[0])) : a.fail({ errCode: b.data.infocode, errMsg: b.data.info })
      },
      fail: function (b) {
...
AMapWX.prototype.getWeather = function (a) {
  function d (d) {
    ...
    a.type && a.type == 'forecast' && (e = 'all'), wx.request({
      ...
      success: function (b) {
        ...
        let d, e
        b.data.status && b.data.status == '1' ? b.data.lives ? (d = b.data.lives, d && d.length > 0 && (d = d[0], e = c(d), e.liveData = d, a.success(e))) : b.data.forecasts && b.data.forecasts[0] && a.success({ forecast: b.data.forecasts[0] }) : a.fail({
  ...
  var b = this; var c = b.requestConfig
...
AMapWX.prototype.getStaticmap = function (a) {
  ...
  let e; const b = this; var c = []; var d = 'https://restapi.amap.com/v3/staticmap?'
...
AMapWX.prototype.getInputtips = function (a) {
  const b = this; const c = b.requestConfig
  const d = { key: b.key, s: c.s, platform: c.platform, appname: b.key, sdkversion: c.sdkversion, logversion: c.logversion }
